 ...
 * Function : getName
 * 
 * @return a character array entered by the user.
 * 
 ...
 * 
 * Manages unused and inaccessible space created by deleting files.
 * Necessary due to the nature of the implementation.
 *
 */
void organizeMemory() {
